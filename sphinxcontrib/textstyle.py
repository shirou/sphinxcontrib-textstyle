...
def setup(app):
    ...
    app.add_node(rubytag.RubyTag,
                 html=(rubytag.visit_rubytag_node,
                       rubytag.depart_rubytag_node),
                 epub=(rubytag.visit_rubytag_node,
                       rubytag.depart_rubytag_node))
    ...
    app.add_node(deltag.DelTag,
                 html=(deltag.visit_deltag_node,
                       deltag.depart_deltag_node),
                 epub=(deltag.visit_deltag_node,
                       deltag.depart_deltag_node))
    ...
    app.add_node(color.Color,
                 html=(color.visit_color_node,
                       color.depart_color_node),
                 epub=(color.visit_color_node,
                       color.depart_color_node))
